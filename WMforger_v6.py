...
TEMP_OUT_DIR = Path("/scratch/bjoshi/watermark/submission_temp_wmforger_v6")  # where this script will put the forged outputs
FILE_PATH    = "/scratch/bjoshi/watermark/submission_wmforger_v6.zip"
