...
TEMP_OUT_DIR = Path("/scratch/bjoshi/watermark/submission_temp_wmforger_v4")  # where this script will put the forged outputs
FILE_PATH    = "/scratch/bjoshi/watermark/submission_wmforger_v4.zip"
...
# The preference model operates at a fixed working resolution (the official
# script uses 768). Extraction happens here; the resulting watermark is then
# resized to each category's / target's native size.
WORK_SIZE = 768
