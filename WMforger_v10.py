...
TEMP_OUT_DIR = Path("/scratch/bjoshi/watermark/submission_temp_wmforger_v10")
FILE_PATH    = "/scratch/bjoshi/watermark/submission_wmforger_v10.zip"
...
MASK_CATEGORIES = {"WM_6"}   # set() to disable everywhere; add names to extend
