...
TEMP_OUT_DIR = Path("/scratch/bjoshi/watermark/submission_temp_wmforger_v7")  # where this script will put the forged outputs
FILE_PATH    = "/scratch/bjoshi/watermark/submission_wmforger_v7.zip"
...
EXTRACTION_MODE = "per_source"  # "mean", "median", "per_source", "per_source_cycle"
