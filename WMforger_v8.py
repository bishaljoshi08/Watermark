...
TEMP_OUT_DIR = Path("/scratch/bjoshi/watermark/submission_temp_wmforger")
FILE_PATH    = "/scratch/bjoshi/watermark/submission_wmforger.zip"
...
NUM_STEPS = 150   # confirmed: 150 recovered WM_8 and gave 0.963 overall Sqlt
LR        = 0.05


ALPHA = 1.7   # default for the strong categories
ALPHA_PER_CATEGORY = {
