...
TEMP_OUT_DIR = Path("/scratch/bjoshi/watermark/submission_temp_wmforger_v9")
FILE_PATH    = "/scratch/bjoshi/watermark/submission_wmforger_v9.zip"
...
ALPHA = 2   # default for the strong categories
ALPHA_PER_CATEGORY = {
    "WM_6": 1.3,   # weakest category - don't push; rely on masking instead
}
